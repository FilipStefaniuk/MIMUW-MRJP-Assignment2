...
instance Print TopDef where
  prt i e = case e of
    TopFunDef fundef -> prPrec i 0 (concatD [prt 0 fundef])
    ClassDef id classitemdefs -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id, doc (showString "{"), prt 0 classitemdefs, doc (showString "}")])
    ClassExtDef id1 id2 classitemdefs -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id1, doc (showString "extends"), prt 0 id2, doc (showString "{"), prt 0 classitemdefs, doc (showString "}")])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
instance Print ClassItemDef where
  prt i e = case e of
    AttrDef type_ id -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString ";")])
    MethodDef fundef -> prPrec i 0 (concatD [prt 0 fundef])
  prtList _ [] = (concatD [])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
instance Print FunDef where
  prt i e = case e of
    FunDef type_ id args block -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])

instance Print Arg where
  prt i e = case e of
    Ar type_ id -> prPrec i 0 (concatD [prt 0 type_, prt 0 id])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
...
instance Print LVal where
  prt i e = case e of
    ...
    LArr expr1 expr2 -> prPrec i 0 (concatD [prt 7 expr1, doc (showString "["), prt 0 expr2, doc (showString "]")])
    LAttr expr id -> prPrec i 0 (concatD [prt 7 expr, doc (showString "."), prt 0 id])
    LSelf -> prPrec i 0 (concatD [doc (showString "self")])
...
instance Print Type where
  prt i e = case e of
    ...
    Obj id -> prPrec i 0 (concatD [prt 0 id])
    Null -> prPrec i 0 (concatD [doc (showString "null")])
...
instance Print Expr where
  prt i e = case e of
    ...
    EVar lval -> prPrec i 7 (concatD [prt 0 lval])
