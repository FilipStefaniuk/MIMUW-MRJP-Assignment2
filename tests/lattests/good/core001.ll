...
@.str = constant [1 x i8] c"\00"
@.str.3 = constant [9 x i8] c"/* world\00"
@.str.1 = constant [2 x i8] c"=\00"
@.str.2 = constant [9 x i8] c"hello */\00"
...
define i32 @main() {
	...
	%5 = getelementptr inbounds [1 x i8], [1 x i8]* @.str, i32 0, i32 0
	store i8* %5, i8** %r
	store i32 10, i32* %n
	store i32 1, i32* %r1
	br label %6
...
; <label>: 15
	...
	%17 = getelementptr inbounds [2 x i8], [2 x i8]* @.str.1, i32 0, i32 0
	%18 = call i8* @repStr(i8* %17, i32 60)
	call void @printString(i8* %18)
	%19 = getelementptr inbounds [9 x i8], [9 x i8]* @.str.2, i32 0, i32 0
	call void @printString(i8* %19)
	%20 = getelementptr inbounds [9 x i8], [9 x i8]* @.str.3, i32 0, i32 0
...
define i8* @repStr(i8* %s, i32 %n) {
	...
	store i8* %s, i8** %1
	store i32 %n, i32* %2
	%3 = getelementptr inbounds [1 x i8], [1 x i8]* @.str, i32 0, i32 0
	store i8* %3, i8** %r
	store i32 0, i32* %i
	br label %4
